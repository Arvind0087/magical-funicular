...
import MenuPopupPyqs from "./component/MenuPopupPyqs";
import CustomTable from "components/CustomTable";
import { getAllPyqsAsync } from "redux/freeResource/freeresource.async";
...
export default function Topic() {
  ...
  const { allPyqsLoader, allPyqs } = useSelector((state) => state.freeresource);
