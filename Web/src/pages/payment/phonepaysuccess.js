...
// import { getPhonepayPaymentStatusAsync } from "redux/PaymentStatus/phonepay";
...
const PaymentResponse = () => {
  ...
  const merchantTransactionId = query.get("ref_id");
  ...
  //   useMemo(() => {
  //     dispatch(
  //       getPhonepayPaymentStatusAsync({ merchantTransactionId, token: token })
  //     );
  //   }, []);
  ...
  const orderInfo = [
    {
      label: "Order Id",
      // value: paymentstatus?.merchantTransactionId,
      value: "HGFGF1111",
    },
    {
      label: "Total Amount",
    ...
    <>
      {/*paymentstatusLoader && (
        ...
        >
          ...
          <Typography sx={{ mt: "20px", fontFamily: "'Poppins', sans-serif" }}>
